    ...
    render() {
        return (
            <div>
                ...
                <p>As a host, start by creating a survey or quiz on the <a href='#' onClick={this._redirectCreate}>Create</a> page. Then, view the survey or quiz you created in the <a href='#' onClick={this._redirectSurvey}>Your Surveys</a> or <a href='#' onClick={this._redirectQuiz}>Your Quizzes</a> page respectively. From this page, you have a few options:
                    <ul>
                        ...
                        <li>Activate: Sends the selected survey/quiz to all connected users.</li>
                        <li>Edit: Allows you to edit the selected survey/quiz. </li>
                        <li>Delete: Will delete </li>
                    </ul>
                </p>
            </div>
        )
